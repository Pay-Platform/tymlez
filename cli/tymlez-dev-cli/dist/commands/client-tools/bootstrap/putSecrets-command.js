...
function handler({ bootstrapFilePath, secretsFilePath, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, backend_libs_1.validateBootstrap)({
            bootstrap: bootstrapWithSecrets,
            allowSecret: true,
        });
        const bootstrapSecretsText = JSON.stringify(bootstrapSecrets);
        const bootstrapSecretsMd5 = yield (0, md5_1.default)(bootstrapSecretsText);
        ...
        yield s3
            ...
            .promise();
        const bootstrapContent = yield readFile(bootstrapFilePath, 'utf-8');
        const newBootstrapContent = bootstrapContent.replace(/secrets_hash: '[^']+'/, `secrets_hash: '${bootstrapSecretsMd5}'`);
        yield writeFile(bootstrapFilePath, newBootstrapContent);
...
const desc = 'Put secrets to AWS S3 and update the version ID in bootstrap file';
exports.desc = desc;
const builder = {
    bootstrapFilePath: {
...
//# sourceMappingURL=putSecrets-command.js.map