    ...
    return (<>
      ...
      <Box component="main" ref={rootRef} sx={{
        ...
        <InvoiceListInner open={openFilters}>
          ...
          <InvoiceListTable group={group} invoices={paginatedInvoices} invoicesCount={filteredInvoices.length} onPageChange={handlePageChange} onRowsPerPageChange={handleRowsPerPageChange} page={page} rowsPerPage={rowsPerPage}/>
        </InvoiceListInner>
      </Box>
    </>);
};
InvoiceList.getLayout = (page) => (<AuthGuard>
