    ...
    return (<>
      ...
      <Box component="main" sx={{
        ...
        <Container maxWidth="md">
          <Grid alignItems="center" container sx={{
          ...
          <div>
            {companies.map((company) => (<Card key={company.id} sx={{ mt: 4 }}>
                <CardContent>
                  <Box sx={{
                display: 'flex',
                flexDirection: {
                    ...
                    <NextLink href="/dashboard/jobs/companies/1" passHref>
                      <Avatar component="a" src={company.logo} sx={{
...
JobBrowse.getLayout = (page) => (<AuthGuard>
