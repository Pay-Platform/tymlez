...
const OrderList = () => {
    ...
    return (<>
      ...
      <Box component="main" ref={rootRef} sx={{
        ...
        <OrderListInner open={drawer.isOpen}>
          <Box sx={{ px: 3 }}>
            ...
            <Tabs indicatorColor="primary" onChange={handleTabsChange} scrollButtons="auto" textColor="primary" value={currentTab} sx={{ mt: 3 }} variant="scrollable">
          ...
          <Box sx={{
            ...
            <Box component="form" onSubmit={handleQueryChange} sx={{
            flexGrow: 1,
            m: 1.5,
        }}>
          ...
          <Divider />
          <OrderListTable onOpenDrawer={handleOpenDrawer} onPageChange={handlePageChange} onRowsPerPageChange={handleRowsPerPageChange} orders={paginatedOrders} ordersCount={filteredOrders.length} page={page} rowsPerPage={rowsPerPage}/>
        </OrderListInner>
...
OrderList.getLayout = (page) => (<AuthGuard>
