    ...
    return (<>
      ...
      <Box component="main" sx={{
        ...
        <Container maxWidth="lg">
          <Box style={{ backgroundImage: `url(${profile.cover})` }} sx={{
            ...
            <Button startIcon={<AddPhotoIcon fontSize="small"/>} sx={{
          ...
          <Box sx={{
            ...
            display: {
              ...
              {connectedStatus === 'not_connected' && (<Button onClick={handleConnectToggle} size="small" startIcon={<UserAddIcon fontSize="small"/>} sx={{ ml: 2 }} variant="outlined">
                  Connect
                </Button>)}
              {connectedStatus === 'pending' && (<Button color="primary" onClick={handleConnectToggle} size="small" sx={{ ml: 2 }} variant="outlined">
                  Pending
                </Button>)}
              <NextLink href="/dashboard/chat" passHref>
                <Button component="a" size="small" startIcon={<ChatIcon fontSize="small"/>} sx={{ ml: 1 }} variant="contained">
                  Send Message
                </Button>
              </NextLink>
            </Box>
...
SocialProfile.getLayout = (page) => (<AuthGuard>
