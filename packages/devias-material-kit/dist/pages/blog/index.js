    ...
    return (<>
      ...
      <Box component="main" sx={{
        ...
        <Container maxWidth="md">
          ...
          <Divider sx={{ my: 3 }}/>
          {posts.map((post) => (<BlogPostCard authorAvatar={post.author.avatar} authorName={post.author.name} category={post.category} cover={post.cover} key={post.title} publishedAt={post.publishedAt} readTime={post.readTime} shortDescription={post.shortDescription} title={post.title}/>))}
          <Box sx={{
            alignItems: 'center',
            display: 'flex',
