...
export const GroupedList2 = () => (<Box sx={{
    ...
    <Container maxWidth="sm">
      <Card sx={{
        ...
        <CardHeader action={<IconButton>
            ...
            </IconButton>} title="Top Referrals"/>
        <Divider />
        <List disablePadding>
          {referrals.map((referral, i) => (<ListItem divider={i < referrals.length - 1} key={referral.name}>
              <ListItemAvatar>
                <Avatar sx={{
            ...
            fontWeight: 600,
              ...
              <ListItemText primary={referral.name} primaryTypographyProps={{
            color: 'textPrimary',
            variant: 'subtitle2',
        }}/>
