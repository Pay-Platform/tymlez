    ...
    <form onSubmit={(event) => event.preventDefault()}>
      ...
      <CardContent>
        <Grid container spacing={4}>
          ...
          <Grid item md={6} xs={12}>
            <Autocomplete getOptionLabel={(option) => option.text} options={countries} renderInput={(params) => (<TextField fullWidth label="Country" name="country" {...params}/>)}/>
          </Grid>
          <Grid item md={6} xs={12}>
