...
import { Avatar, Box, Button, Card, CardHeader, Divider, IconButton, Table, TableBody, TableCell, TableHead, TableRow, TableSortLabel, Tooltip, Typography, } from '@mui/material';
...
export const Table2 = () => (<Box sx={{
    ...
    <Card>
      <CardHeader action={<IconButton>
          ...
          </IconButton>} title="Latest Projects"/>
      <Divider />
      <Scrollbar>
        <Table sx={{ minWidth: 900 }}>
          ...
          <TableBody>
            {projects.map((project) => (<TableRow hover key={project.id}>
            ...
            display: 'flex',
                ...
                <TableCell>
                  {project.technologies.map((technology) => (<Box component="span" key={technology} sx={{
                '& + &': {
                    ml: 1,
                },
                '& img': {
