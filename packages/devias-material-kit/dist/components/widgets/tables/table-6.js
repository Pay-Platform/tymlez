...
import { Box, Card, Checkbox, IconButton, InputAdornment, Link, Table, TableBody, TableCell, TableHead, TablePagination, TableRow, TextField, Typography, } from '@mui/material';
    ...
    <Card>
      ...
      <Scrollbar>
        <Table sx={{ minWidth: 1200 }}>
          ...
          <TableBody>
            {invoices.map((invoice) => (<TableRow hover key={invoice.id}>
                <TableCell padding="checkbox">
                  <Checkbox />
                </TableCell>
                <TableCell>
      ...
      <TablePagination component="div" count={invoices.length} onPageChange={() => { }} onRowsPerPageChange={() => { }} page={0} rowsPerPage={5} rowsPerPageOptions={[5, 10, 25]}/>
    </Card>
  </Box>);
