...
import { Box, Button, Card, CardHeader, Divider, IconButton, Table, TableBody, TableCell, TableHead, TableRow, TableSortLabel, Tooltip, Typography, } from '@mui/material';
...
export const Table1 = () => (<Box sx={{
    ...
    <Card>
      <CardHeader action={<IconButton>
          ...
          </IconButton>} title="Latest Orders"/>
      <Divider />
      <Scrollbar>
        <Table sx={{ minWidth: 700 }}>
          ...
          <TableBody>
            {orders.map((order) => (<TableRow hover key={order.id}>
                <TableCell>
