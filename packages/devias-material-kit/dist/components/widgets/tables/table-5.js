...
import { Box, Card, Checkbox, FormControlLabel, IconButton, InputAdornment, Link, Switch, Table, TableBody, TableCell, TableHead, TablePagination, TableRow, TextField, } from '@mui/material';
    ...
    <Card>
      <Box sx={{
        ...
        width: 240,
          ...
          <TextField fullWidth label="Category" name="category" select SelectProps={{ native: true }}>
            {categoryOptions.map((categoryOption) => (<option key={categoryOption.value} value={categoryOption.value}>
        ...
        width: 240,
          ...
          <TextField fullWidth label="Availability" name="availability" select SelectProps={{ native: true }}>
            {availabilityOptions.map((availabilityOption) => (<option key={availabilityOption.value} value={availabilityOption.value}>
      ...
      <Scrollbar>
        <Table sx={{ minWidth: 1200 }}>
          ...
          <TableBody>
            {products.map((product) => (<TableRow hover key={product.id}>
                <TableCell padding="checkbox">
                  <Checkbox />
                </TableCell>
                <TableCell>
      ...
      <TablePagination component="div" count={products.length} onPageChange={() => { }} onRowsPerPageChange={() => { }} page={0} rowsPerPage={5} rowsPerPageOptions={[5, 10, 25]}/>
    </Card>
  </Box>);
