...
export const GridList4 = () => (<Box sx={{
        backgroundColor: 'background.default',
        minHeight: '100%',
        p: 3,
    }}>
    <Grid container spacing={3}>
      {applicants.map((applicant) => (<Grid item key={applicant.id} md={4} xs={12}>
          <Card>
            ...
            mt: '-50px',
                ...
                <Avatar alt="Applicant" src={applicant.avatar} sx={{
            ...
            width: 100,
              ...
              <Divider sx={{ my: 2 }}/>
              <Box sx={{ m: -0.5 }}>
                {applicant.skills.map((skill) => (<Chip key={skill} label={skill} sx={{ m: 0.5 }} variant="outlined"/>))}
              </Box>
            </CardContent>
          </Card>
        </Grid>))}
