...
export const DetailList8 = () => (<Box sx={{
      ...
      <CardContent>
        ...
        <List>
          <ListItem disableGutters divider>
            ...
            <ListItemText disableTypography primary={<Typography variant="subtitle2">
                  Product Designer at{' '}
                  <Link color="textPrimary" href="#" variant="subtitle2">
                    Devias
                  </Link>
                </Typography>} secondary={<Typography color="textSecondary" variant="caption">
                  Past: UX Designer{' '}
          ...
          <ListItem disableGutters divider>
            ...
            <ListItemText primary={<Link color="textSecondary" sx={{ cursor: 'pointer' }} variant="body2">
