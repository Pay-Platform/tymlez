...
export const DetailList7 = () => (<Box sx={{
        backgroundColor: 'background.default',
        minHeight: '100%',
        p: 3,
    }}>
    <Card>
      <CardHeader avatar={<Avatar src="/static/mock-images/avatars/avatar-omar_darobe.png"/>} disableTypography subheader={<Link color="textPrimary" underline="none" variant="subtitle2">
            Omar Darobe
          </Link>} style={{ paddingBottom: 0 }} title={<Typography color="textSecondary" sx={{ display: 'block' }} variant="overline">
            Contest holder
          </Typography>}/>
      <CardContent sx={{ pt: 0 }}>
        <List>
          <ListItem disableGutters divider sx={{
