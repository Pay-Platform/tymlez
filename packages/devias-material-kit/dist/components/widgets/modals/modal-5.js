...
export const Modal5 = () => (<Box sx={{
    ...
    <Paper elevation={12} sx={{
      ...
      <List disablePadding>
        ...
        return (<ListItem divider key={notification.id}>
              <ListItemAvatar>
                <Avatar sx={{
              ...
              <ListItemText primary={<Link color="textPrimary" sx={{ cursor: 'pointer' }} underline="none" variant="subtitle2">
                    {notification.title}
                  </Link>} secondary={notification.description}/>
            </ListItem>);
    })}
      </List>
      <Box sx={{
