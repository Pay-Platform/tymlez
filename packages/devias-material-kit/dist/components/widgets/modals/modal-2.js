...
export const Modal2 = () => (<Box sx={{
    ...
    <Paper elevation={12} sx={{
      ...
      {Object.keys(languageOptions).map((language) => (<MenuItem key={language}>
          <ListItemIcon>
            <Box sx={{
            display: 'flex',
            height: 20,
          ...
          <ListItemText primary={<Typography color="textPrimary" variant="subtitle2">
