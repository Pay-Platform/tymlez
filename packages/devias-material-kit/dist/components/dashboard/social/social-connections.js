      ...
      <Box sx={{ p: 3 }}>
        <Grid container spacing={3}>
          {connections
            ...
            .map((connection) => (<Grid item key={connection.id} md={6} xs={12}>
                ...
                p: 2,
                    ...
                    <NextLink href="#" passHref>
                      <Avatar component="a" src={connection.avatar} sx={{
                height: 56,
                width: 56,
            }}/>
                    </NextLink>
                ...
                mx: 2,
                      ...
                      {connection.status !== 'rejected' && (<Button onClick={() => handleConnectToggle(connection.id)} size="small" variant="outlined">
