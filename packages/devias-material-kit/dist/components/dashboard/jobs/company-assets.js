    ...
    return (<div {...other}>
      ...
      <Box sx={{ mt: 3 }}>
        <Grid container spacing={3}>
          {assets.map((asset) => (<Grid item key={asset.id} sm={6} xs={12}>
              <Box sx={{
                borderColor: 'divider',
                borderRadius: 1,
                borderStyle: 'solid',
                ...
                vertical: 'bottom',
                horizontal: 'right',
            }} badgeContent={asset.extension.toUpperCase()} color="primary">
                    {asset.extension === 'pdf' ? (<img alt="" src="/static/document_text.svg" width="40px" height="50px"/>) : (<img alt="" src="/static/photograph.svg" width="50px" height="45px"/>)}
                  </Badge>
                </Box>
                <Divider />
                <Box sx={{
