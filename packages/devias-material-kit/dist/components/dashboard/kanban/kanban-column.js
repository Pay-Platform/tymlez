    ...
    return (<div {...other}>
      <Box sx={{
        ...
        <Box sx={{
          ...
          {isRenaming ? (<ClickAwayListener onClickAway={handleRename}>
              <OutlinedInput autoFocus fullWidth onBlur={handleRename} onChange={handleChange} value={name} sx={{
            ...
            </ClickAwayListener>) : (<Input disableUnderline fullWidth onClick={handleRenameInit} value={column.name} sx={{
        ...
        <Box sx={{
          ...
          <Droppable droppableId={column.id} type="card">
            {(provided) => (<Box ref={provided.innerRef} sx={{
                ...
                {column.cardIds.map((cardId, index) => (<Draggable draggableId={cardId} index={index} key={cardId}>
                    {(_provided, snapshot) => (<KanbanCard cardId={cardId} dragging={snapshot.isDragging} index={index} key={cardId} column={column} ref={_provided.innerRef} style={{ ..._provided.draggableProps.style }} {..._provided.draggableProps} {..._provided.dragHandleProps}/>)}
                  </Draggable>))}
        ...
        <Menu anchorEl={moreRef.current} anchorOrigin={{
            horizontal: 'center',
            vertical: 'bottom',
        }} keepMounted onClose={handleMenuClose} open={openMenu}>
