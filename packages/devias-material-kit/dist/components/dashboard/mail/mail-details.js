...
export const MailDetails = (props) => {
    ...
    return (<Box sx={{
      ...
      <Box sx={{
        ...
        }} placeholder="Search message" size="small" sx={{ width: 200 }}/>
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Avatar src={email.from.avatar} sx={{
            height: 48,
            width: 48,
        }}>
          ...
          <Box sx={{ ml: 2 }}>
            ...
            <Typography color="textSecondary" variant="subtitle2">
              To:{' '}
              {email.to.map((person) => (<Link color="inherit" key={person.email}>
                  {person.email}
                </Link>))}
            </Typography>
          ...
          <MarkdownWrapper>
            ...
            {email.attachments && (<Box sx={{ mt: 6 }}>
                ...
                m: -1,
                  ...
                  {email.attachments.map((attachment) => (<Box key={attachment.id} sx={{
                    alignItems: 'center',
                    cursor: 'pointer',
                    display: 'flex',
                    m: 1,
                }}>
                      {attachment.type === 'image' ? (<Avatar src={attachment.url} variant="rounded"/>) : (<Avatar variant="rounded" sx={{
