...
export const ChatThreadItem = (props) => {
    ...
    return (<ListItem disableGutters disablePadding divider onClick={onSelect} sx={{
      ...
      <ListItemAvatar sx={{
        ...
        <AvatarGroup max={2} sx={{
          ...
          {recipients.map((recipient) => (<Avatar key={recipient.id} src={recipient.avatar}/>))}
        </AvatarGroup>
      </ListItemAvatar>
      <Box sx={{
            flexGrow: 1,
