...
export const ChatMessages = (props) => {
    ...
    return (<Box sx={{ p: 2 }} {...other}>
      {messages.map((message) => {
            ...
            return (<ChatMessage authorAvatar={authorAvatar} authorName={authorName} authorType={authorType} body={message.body} contentType={message.contentType} createdAt={message.createdAt} key={message.id}/>);
        })}
    </Box>);
};
