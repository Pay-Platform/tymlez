...
import { Box, Button, Card, CardActions, CardHeader, Divider, Table, TableBody, TableCell, TableHead, TableRow, TableSortLabel, Tooltip, Typography, } from '@mui/material';
import { InformationCircleOutlined as InformationCircleOutlinedIcon } from '../../../icons/information-circle-outlined';
import { ArrowRight as ArrowRightIcon } from '../../../icons/arrow-right';
const sortCountries = (countries, order) => countries.sort((a, b) => {
    if (order === 'asc') {
...
export const AnalyticsVisitsByCountry = (props) => {
    ...
    return (<Card {...props}>
      <CardHeader title="Keywords by country" action={<Tooltip title="Refresh rate is 24h">
      ...
      <Table>
        ...
        <TableBody>
          {sortedCountries.map((country) => (<TableRow key={country.name} sx={{
                '&:last-child td': {
                    border: 0,
                },
            }}>
