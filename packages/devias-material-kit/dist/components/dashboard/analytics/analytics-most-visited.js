...
export const AnalyticsMostVisited = () => (<Card>
    <CardHeader title="Most Visited Pages" action={<Tooltip title="Refresh rate is 24h">
    ...
    <Scrollbar>
      <Table sx={{ minWidth: 600 }}>
        ...
        <TableBody>
          {pages.map((page) => (<TableRow key={page.url} sx={{
            '&:last-child td': {
                border: 0,
            },
        }}>
