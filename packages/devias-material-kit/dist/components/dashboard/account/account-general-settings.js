        ...
        <CardContent>
          <Grid container spacing={3}>
            ...
            alignItems: 'center',
                ...
                <TextField defaultValue={user.name} label="Full Name" size="small" sx={{
            flexGrow: 1,
            mr: 3,
        }}/>
                <Button>Save</Button>
            ...
            alignItems: 'center',
                ...
                <TextField defaultValue="dummy.account@gmail.com" disabled label="Email Address" required size="small" sx={{
            flexGrow: 1,
            mr: 3,
