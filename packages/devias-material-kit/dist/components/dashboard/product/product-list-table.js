...
import { Box, Button, CardContent, Divider, Grid, IconButton, InputAdornment, LinearProgress, MenuItem, Switch, Table, TableBody, TableCell, TableHead, TablePagination, TableRow, TextField, Typography, } from '@mui/material';
...
export const ProductListTable = (props) => {
    ...
    return (<div {...other}>
          ...
          <TableBody>
            ...
            return (<Fragment key={product.id}>
                  <TableRow hover key={product.id}>
                    ...
                    <TableCell width="25%">
                      <LinearProgress value={product.quantity} variant="determinate" color={product.quantity >= 10 ? 'success' : 'error'} sx={{
                    height: 8,
                    width: 36,
                }}/>
                      <Typography color="textSecondary" variant="body2">
                  ...
                  {open && (<TableRow>
                      <TableCell colSpan={7} sx={{
                        ...
                        <CardContent>
                          <Grid container spacing={3}>
                            ...
                            <Grid item md={6} xs={12}>
                              ...
                              <Grid container spacing={3}>
                                <Grid item md={6} xs={12}>
                                  <TextField defaultValue={product.price} fullWidth label="Old price" name="old-price" InputProps={{
                        startAdornment: (<InputAdornment position="start">
                                ...
                                <Grid item md={6} xs={12}>
                                  <TextField defaultValue={product.price} fullWidth label="New price" name="new-price" InputProps={{
                        startAdornment: (<InputAdornment position="start">
                                          $
                                        </InputAdornment>),
                    }} type="number"/>
                        ...
                        py: 1,
                          ...
                          <Button onClick={handleDeleteProduct} color="error" sx={{
                        m: 1,
                        ml: 'auto',
                    }}>
                            Delete product
      ...
      <TablePagination component="div" count={productsCount} onPageChange={onPageChange} onRowsPerPageChange={onRowsPerPageChange} page={page} rowsPerPage={rowsPerPage} rowsPerPageOptions={[5, 10, 25]}/>
    </div>);
};
