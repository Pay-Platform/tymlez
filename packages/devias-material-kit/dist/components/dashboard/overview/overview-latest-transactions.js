...
export const OverviewLatestTransactions = (props) => (<Card {...props}>
    ...
    <Scrollbar>
      <Table sx={{ minWidth: 600 }}>
        ...
        <TableBody>
          {transactions.map((transaction) => (<TableRow key={transaction.id} sx={{
            '&:last-child td': {
                border: 0,
            },
        }}>
            ...
            : 'Payment sent'}
              ...
              <TableCell>
                <SeverityPill color={(transaction.status === 'confirmed' && 'success') ||
            ...
            'warning'}>
              ...
              <TableCell width={180}>
                <Typography color={transaction.type === 'receive'
            ? 'success.main'
            : 'error.main'} variant="subtitle2">
                  {transaction.type === 'receive' ? '+' : '-'}{' '}
