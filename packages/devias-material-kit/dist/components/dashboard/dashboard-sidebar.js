...
const getSections = (t) => [
    {
        ...
        items: [
            ...
            },
            {
                ...
                chip: (<Chip color="secondary" label={<Typography sx={{
                            fontSize: '10px',
                            fontWeight: '600',
                        }}>
                NEW
...
export const DashboardSidebar = (props) => {
    ...
    const content = (<>
      <Scrollbar sx={{
        ...
        <Box sx={{
          ...
          <div>
            ...
            <Box sx={{ px: 2 }}>
              <Box onClick={handleOpenOrganizationsPopover} ref={organizationsRef} sx={{
            alignItems: 'center',
          ...
          <Box sx={{ flexGrow: 1 }}>
            {sections.map((section) => (<DashboardSidebarSection key={section.title} path={router.asPath} sx={{
                mt: 2,
                '& + &': {
                    mt: 2,
                },
      ...
      <OrganizationPopover anchorEl={organizationsRef.current} onClose={handleCloseOrganizationsPopover} open={openOrganizationsPopover}/>
    </>);
    if (lgUp) {
