...
exports.fetchFirstLongEnergies = void 0;
...
async function fetchFirstLongEnergies({ requests, }) {
    return (0, common_libs_1.runAllSettled)(requests, async (requestOrError) => {
        ...
        pino_1.logger.info(params, `Fetching first long energy for ${deviceId}`);
        const { data } = await axios_1.default.get(`${constants_1.WATTWATCHERS_API_URL}/long-energy/${deviceId}/first`, {
            headers: {
...
exports.fetchFirstLongEnergies = fetchFirstLongEnergies;
//# sourceMappingURL=fetchFirstLongEnergies.js.map