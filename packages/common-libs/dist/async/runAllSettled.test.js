...
const runAllSettled_1 = require("./runAllSettled");
describe('runAllSettled', () => {
    describe('given the callback pass, when called with empty array input', () => {
        ...
        let result;
        beforeAll(async () => {
            result = await (0, runAllSettled_1.runAllSettled)([], callback);
        });
    ...
    describe('given the callback pass, when called with array 1 non error item', () => {
        ...
        let result;
        beforeAll(async () => {
            result = await (0, runAllSettled_1.runAllSettled)([{ input: 1 }], callback);
        });
    ...
    describe('given the callback pass, when called with array 2 non error items', () => {
        ...
        let result;
        beforeAll(async () => {
            result = await (0, runAllSettled_1.runAllSettled)([{ input: 1 }, { input: 2 }], callback);
        });
    ...
    describe(`given the callback pass, 
        ...
        let result;
        beforeAll(async () => {
            result = await (0, runAllSettled_1.runAllSettled)([{ input: 1 }, new Error('test error 1')], callback);
        });
        it('should return array with 2 item from callback', () => {
...
//# sourceMappingURL=runAllSettled.test.js.map