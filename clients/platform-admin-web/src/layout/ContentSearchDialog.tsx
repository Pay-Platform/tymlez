...
import { wait } from '@tymlez/devias-material-kit/dist/utils/wait';
import { X as XIcon } from '@tymlez/devias-material-kit/dist/icons/x';
import { Tip } from '@tymlez/devias-material-kit/dist/components/tip';
          ...
          <>
            {Object.keys(results).map((type) => (
              <div key={`div_${type}`}>
                ...
                >
                  {results[type].map((result: any, index: number) => (
